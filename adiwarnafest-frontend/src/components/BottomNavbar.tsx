...
import { House, Trophy, MapTrifold, Sparkle, Ticket } from '@phosphor-icons/react';
...
const navItems = [
  ...
  { id: 'visitor-pass', label: 'Visitor Pass', icon: Ticket, path: '/visitor-pass' },
];
      ...
      {activeIndex >= 0 && (
        <div
          style={{
            ...
            height: '50px',
            borderRadius: '14px',
            background: 'linear-gradient(-75deg, rgba(161,64,0,0.22), rgba(254,178,70,0.7), rgba(161,64,0,0.22))',
            border: '1px solid rgba(161,64,0,0.45)',
            boxShadow: 'inset 0 2px 3px rgba(255,255,255,0.75), inset 0 -2px 3px rgba(161,64,0,0.25), 0 6px 16px rgba(161,64,0,0.3)',
