# Seed all teams and players into the Adiwarna backend
# Usage: .\seed-teams.ps1 -Email "admin@email.com" -Password "yourpassword"
param(
...
$teams = @(
    ...
    # ── FUTSAL ────────────────────────────────────────────────────────────────
    @{
        name = "Victoria FC"; gameType = "Futsal"
        players = 1..12 | ForEach-Object { @{ name = "Player $_"; playerNumber = $_ } }
    },
    @{
        name = "Eunion"; gameType = "Futsal"
        players = 13..24 | ForEach-Object { @{ name = "Player $_"; playerNumber = $_ } }
    },
    @{
        name = "Himba"; gameType = "Futsal"
        players = 25..36 | ForEach-Object { @{ name = "Player $_"; playerNumber = $_ } }
    },
    @{
        name = "Arjuna"; gameType = "Futsal"
        players = 37..48 | ForEach-Object { @{ name = "Player $_"; playerNumber = $_ } }
    },
    @{
        name = "Es Cekek"; gameType = "Futsal"
        players = 49..60 | ForEach-Object { @{ name = "Player $_"; playerNumber = $_ } }
    },

    # ── BASKETBALL 5x5 ────────────────────────────────────────────────────────
    @{
        name = "Spongbob"; gameType = "Basketball5v5"
        players = 61..74 | ForEach-Object { @{ name = "Player $_"; playerNumber = $_ } }
    },
    @{
        name = "Bhinlyon"; gameType = "Basketball5v5"
        players = 75..90 | ForEach-Object { @{ name = "Player $_"; playerNumber = $_ } }
    },
    @{
        name = "PagiSore"; gameType = "Basketball5v5"
        # jersey numbers capped at 99: players 91-99 keep their number, 100-105 wrap to 0-5
...
foreach ($team in $teams) {
    ...
    try {
        $resp = Invoke-RestMethod -Uri "$ApiBase/api/teams" -Method POST `
